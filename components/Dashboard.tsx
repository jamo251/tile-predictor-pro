    ...
    <div className="h-full flex flex-col gap-8 p-8 overflow-hidden">
      ...
      <div className="shrink-0 flex items-center justify-between">
        <div className="flex items-center gap-2">
            ...
            <div>
                <h1 className="text-lg font-bold tracking-tight text-white leading-tight sm:text-xl">
                  Tile Predictor Pro
                </h1>
        ...
        <div className="relative group">
            ...
            <div className="relative p-6 rounded-3xl glass-panel shadow-2xl">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="font-bold text-white text-sm uppercase tracking-wider">Best pick from your data</h2>
              </div>
              ...
              {topRecommendation ? (
                <div className="space-y-6">
                  <div className="flex items-end justify-between">
                    <div>
                        <span className="text-slate-500 text-[10px] uppercase font-bold block mb-1">Top cell</span>
                  ...
                  <div className="pt-4 border-t border-white/5 flex justify-between items-center text-xs">
                    <span className="text-slate-500">In your history</span>
                ...
                <div className="text-sm text-slate-500 py-6 text-center border border-dashed border-white/10 rounded-2xl leading-relaxed px-3">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="relative flex items-center gap-3 text-white">
                ...
                <span className="tracking-tight">{uploadStatus === 'analyzing' ? 'Reading boards…' : 'Add board screenshots'}</span>
            </div>
          </button>
                  ...
                  <div key={game.id} className="group flex items-center justify-between p-4 glass-panel rounded-2xl hover:border-white/20 transition-all">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-slate-500 font-mono tracking-tighter">{game.tiles.length} tiles read</span>
                      </div>
                    </div>
                    <button 
